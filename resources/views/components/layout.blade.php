...
<body class="mb-48">
  ...
  <header class="bg-white border-gray-200 py-2.5 dark:bg-gray-900">
    <div class="fixed top-0 left-0 w-full flex items-center justify-start font-bold bg-laravel text-white h-24 mt-2 opacity-90 md:justify-center">
        ...
        <div class="items-center justify-between w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
            <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                <li>
                    <a href="/"
                        class="block py-2 pl-3 pr-4 text-white-700 border-b  
...
<script src="https://unpkg.com/flowbite@1.4.1/dist/flowbite.js"></script>
  ...
  <footer
    class="fixed bottom-0 left-0 w-full flex items-center justify-start font-bold bg-laravel text-white h-40 mt-24 opacity-90 md:justify-center">
    <p class="ml-4 ">CONTACT: 673 989 001/696 251 192
    EMAIL:djomokamgang@gmail.com</br>
    WEBSITE: www.kprint.com</br> Copyright &copy; 2025, All Rights reserved</br></p>
    <div class="bg-laravel w-full h-auto  py-5 flex-items-center justify-center gap-4 flex-wrap">
